...
import { OPENAI_COMPATIBLE_MODELS } from '../openai-compatible/openai-compatible.constants';
import { getOpenCodeModels } from '../opencode/opencode.constants';
import { BytebotAgentModel } from 'src/agent/agent.types';

async function buildModelsList(): Promise<BytebotAgentModel[]> {
