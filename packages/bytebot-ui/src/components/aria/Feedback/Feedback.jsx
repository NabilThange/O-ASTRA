...
import { feedbackH1LG, feedbackReviewLG } from "../../../constants/aria/feedback.js";

const reviewImages = {
    review1: "/aria-assets/review1.webp",
    review2: "/aria-assets/review2.webp",
    review3: "/aria-assets/review3.webp"
};
...
const Feedback = () => {
    ...
    return (
        <section className='w-sereen h-dvh p-8 flex flex-col justify-center items-center' style={{ backgroundColor: '#181717' }}>
