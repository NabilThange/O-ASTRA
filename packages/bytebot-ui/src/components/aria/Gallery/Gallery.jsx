    ...
    return (
        <section className="gallery-page4" ref={pageRef} style={{ backgroundColor: '#2b2825' }}>
            ...
            <div className="gallery-background">
                <img src="/aria-assets/background1.webp" alt="Classic Aria" />
            ...
            <div id="gallery-second" className="gallery-background2">
                <img src="/aria-assets/background2.webp" alt="Planner Layer" />
                <div className="gallery-topText">
                    <h4>Planner Layer®</h4>
                    <h3>(Scroll)</h3>
                </div>
            ...
            <div id="gallery-third" className="gallery-background2">
                <img src="/aria-assets/background3.webp" alt="ARIA Pipeline" />
                <div className="gallery-topText">
                    <h4>ARIA Pipeline®</h4>
                    <h3>(Scroll)</h3>
                </div>
