        ...
        <section className="hero-section w-dvw md:h-dvh h-[100vh] md:p-2 p-2.5 mb-20" style={{ backgroundColor: '#181717' }}>
            <div className="relative w-full h-full rounded-[2.5rem] overflow-hidden">
                <div className="responsive-mobile">
                    ...
                    <div className="hero-img absolute inset-0 bg-[url('/aria-assets/hero-img1.webp')] bg-no-repeat bg-cover bg-center z-0 md:block hidden" />

                    {/* Mobile image fallback */}
                    <div className="block lg:hidden mt-6 mb-6 relative w-full h-80">
                        <Image
                            src="/aria-assets/hero-img1.webp"
                            alt="Aria retro computer"
                            fill
                    ...
                    >
                        <source src="/aria-assets/smoke_final.webm" type="video/webm" />
                        <source src="/aria-assets/smoke_final.mp4" type="video/mp4" />
                    </video>
                </div>
                    ...
                    <div className="relative h-dvh">
                        ...
                        <div className="w-full h-auto absolute  top-24 md:bottom-[8%] lg:bottom-[9%] flex md:flex-row flex-col md:justify-between md:items-end">
                            ...
                            <p
                                ...
                                style={{ textShadow: '2px 2px 4px #000' }}
                            >
                                A web-based AI computer use agent that executes tasks live in a sandboxed Chrome browser—transparent, collaborative, and interruptible.
                            </p>
                        </div>
                    </div>
                </div>
