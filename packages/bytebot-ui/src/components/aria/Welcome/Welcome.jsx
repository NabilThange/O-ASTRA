...
import { welcomeLinesLG, welcomeLinesSM } from "../../../constants/aria/welcome.js";
        ...
        <div className='welcome-section w-full h-[120vh] text-[#2A2725]  md:px-7 px-6' style={{ backgroundColor: '#181717' }}>
            ...
            <div className="flex md:flex-row flex-col justify-between items-center md:p-4 md:mt-20 mt-10">
                <div className="flex flex-row justify-center items-center gap-1">
                    <img src="/aria-assets/welcome-1.webp" alt="welcome image" className="md:rounded-[8rem] rounded-[9rem] md:w-56 w-44" />
                    <img src="/aria-assets/welcome-2.webp" alt="welcome image" className="md:rounded-[8rem] rounded-[9rem] md:w-56 w-44" />
                </div>
                <div className="md:w-1/2 w-full md:mt-0 mt-10">
                    <p className="md:text-[2rem] text-[1.4rem] text-[#b1a696] md:leading-[1.1] md:pr-24 font-normal leading-[26px] tracking-[-0.2px]">
                        <span>An AI agent that understands your intent, builds a plan, and executes it live.</span><br />
                        <span>Watch every step in real-time with full transparency and control.</span>
                    </p>
                </div>
            </div>
        </div>
